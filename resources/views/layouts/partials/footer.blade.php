<footer class="bg-primary text-white relative overflow-hidden" role="contentinfo">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            {{-- Quick Links --}}
            <div>
                <h3 class="font-heading font-bold mb-5 text-sm uppercase tracking-wider text-white/80">ลิงก์ด่วน</h3>
                <ul class="space-y-2.5 text-sm">
                    <li><a href="{{ route('home') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>หน้าแรก</a></li>
                    <li><a href="{{ route('news') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>ข่าวสาร</a></li>
                    <li><a href="{{ route('personnel') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>บุคลากร</a></li>
                    <li><a href="{{ route('documents') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>เอกสาร</a></li>
                    <li><a href="{{ route('knowledge') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>แหล่งความรู้</a></li>
                    <li><a href="{{ route('systems') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>ระบบงาน</a></li>
                    <li><a href="{{ route('contact') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>ติดต่อเรา</a></li>
                </ul>
            </div>

            {{-- About School --}}
            <div>
                <h3 class="font-heading font-bold mb-5 text-sm uppercase tracking-wider text-white/80">เกี่ยวกับโรงเรียน</h3>
                <ul class="space-y-2.5 text-sm">
                    <li><a href="{{ route('about.history') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>ประวัติความเป็นมา</a></li>
                    <li><a href="{{ route('about.structure') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>โครงสร้างหน่วย</a></li>
                    <li><a href="{{ route('about.symbols') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>สัญลักษณ์สถานศึกษา</a></li>
                    <li><a href="{{ route('about.philosophy') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>ปรัชญา/วิสัยทัศน์</a></li>
                    <li><a href="{{ route('about.curriculum') }}" class="text-white/50 hover:text-accent-light transition-colors cursor-pointer inline-flex items-center gap-2 group"><svg class="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>หลักสูตร</a></li>
                </ul>
            </div>

            {{-- Contact CTA --}}
            <div>
                <h3 class="font-heading font-bold mb-5 text-sm uppercase tracking-wider text-white/80">ติดต่อเรา</h3>
