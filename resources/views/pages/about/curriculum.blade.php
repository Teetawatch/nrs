        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <nav class="text-sm text-white/60 mb-4" aria-label="Breadcrumb">
                <ol class="flex items-center gap-2">
                    ...
                    <li class="text-white font-medium" data-translate="aboutCurriculum">หลักสูตร</li>
                </ol>
            </nav>
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold animate-fade-up" data-translate="homeCurriculumTitle">หลักสูตรของโรงเรียน</h1>
