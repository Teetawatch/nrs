        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <nav class="text-sm text-white/60 mb-4" aria-label="Breadcrumb">
                <ol class="flex items-center gap-2">
                    ...
                    <li class="text-white font-medium" data-translate="knowledge">แหล่งความรู้</li>
                </ol>
            </nav>
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold animate-fade-up" data-translate="knowledgePageTitle">แหล่งรวมความรู้</h1>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1">
                ...
                <div class="text-center py-20 text-slate-400">
                    ...
                    <p class="text-lg" data-translate="knowledgeNoResult">ยังไม่มีเนื้อหา</p>
                </div>
                @endif
            </div>
